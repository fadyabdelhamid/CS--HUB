...
router.get("/adminresource", async function (req, res) {
  const resources = await Resource.find();
      
  res.render("pages/adminresource", { resources  });
});
router.get("/checkresource", async function (req, res) {
...
router.get("/updateResource/:id", function (req, res) {
...
router.get('/admincourses' ,async function(req, res) {
  const resources = await Resource.find();
